...
class NetworkManager: ObservableObject {
    ...
    //    print(artistsDB[0].artistName)
     //  guard let urlName = URL.getAlbumsByArtistName(name: artistsDB[0].artistName.replacingOccurrences(of: " ", with: "%20", options: .literal, range: nil)) else { return }
        ...
        do {
                    ...
                    print("This Error while decoding!")
                }
